...
TEST_CASE("sdmm::linalg::CoordinateSystem") {
    ...
    CHECK(enoki::slice(coordinates.from.col(1), 0) == Vector{1.f, -0.f, -0.f});
    CHECK(enoki::slice(coordinates.from.col(0), 0) == Vector{-0.f, 1.f, -0.f});

    CHECK(enoki::slice(coordinates.from.col(1), 1) == Vector{0.f, -0.f, -1.f});
    CHECK(enoki::slice(coordinates.from.col(0), 1) == Vector{-0.f, 1.f, -0.f});
}
